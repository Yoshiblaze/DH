export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	hitmonlee: {
		...
		abilities: {0: "Limber", 1: "Magic Guar"},
		heightm: 1.5,
		weightkg: 49.8,
		prevo: "Tyrogue",
		evoLevel: 20,
	...
	dunsparce: {
		...
		name: "Dunsparce",
		types: ["Normal" , "Dragon"],
		baseStats: {hp: 110, atk: 90, def: 90, spa: 70, spd: 90, spe: 45},
		abilities: {0: "Serene Grace", 1: "Overcoa"},
		heightm: 1.5,
		weightkg: 14,
	},
	gligar: {
	...
	cryogonal: {
		...
		abilities: {0: "Levitate", 1: "Ice Bod"},
		heightm: 1.1,
		weightkg: 148,
	},
	typenull: {
