export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	venusaur: {
		...
		types: ["Grass", "Poison"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 80, atk: 100, def: 83, spa: 80, spd: 100, spe: 82},
		abilities: {0: "Overgrow"},
		heightm: 2,
		weightkg: 100,
		prevo: "Ivysaur",
	...
	ledian: {
		...
		name: "Ledian",
		types: ["Bug", "Flying"],
		baseStats: {hp: 60, atk: 40, def: 80, spa: 90, spd: 120, spe: 110},
		abilities: {0: "Shield Dust", 1: "Natural Cure"},
		heightm: 1.4,
		weightkg: 35.6,
		prevo: "Ledyba",
		evoLevel: 18,
	...
	entei: {
		...
		types: ["Fire"],
		gender: "N",
		baseStats: {hp: 115, atk: 90, def: 85, spa: 115, spd: 75, spe: 100},
		abilities: {0: "Pressure"},
		heightm: 2.1,
		weightkg: 198,
	},
	...
	dusclops: {
		...
		name: "Dusclops",
		types: ["Ghost"],
		baseStats: {hp: 65, atk: 70, def: 130, spa: 60, spd: 130, spe: 25},
		abilities: {0: "Pressure"},
		heightm: 1.6,
		weightkg: 30.6,
		prevo: "Duskull",
